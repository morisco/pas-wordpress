function PAS() {
  ...
  pas.showWatch = function(hideIt) {
    ...
    if(!pas.showingWatch && !hideIt){
      ...
      $('.today__day__inner, .today_today').fadeOut(function() {
        $('.today__day__watch, .today__watch').fadeIn(function() {
          pas.watchDisable = false;
        });
      });
    } else {
      ...
      $('.today__day__watch, .today__watch').fadeOut(function() {
        $('.today__day__inner, .today_today').fadeIn(function() {
          pas.watchDisable = false;
        });
      });
    }
  ...
  pas.openModalQuesitonExpanded = function(e) {
  ...
  pas.closeModalQuestionExpanded = function(e){
  ...
  pas.toggleMobileNavHelp = function(e, forceClose) {
    ...
    if(!forceClose && !pas.$mobileNavAccordionContent.hasClass('mobile-nav__accordion-content--open')){
      ...
      pas.helpTimeout = setTimeout(function() {
  ...
  pas.toggleMobileNavSchedule = function(e, forceClose) {
    ...
    if(!forceClose && !pas.$mobileNavAccordionScheduleContent.hasClass('mobile-nav__accordion-content--open')){
      ...
      pas.scheduleTimeout = setTimeout(function() {
        pas.$mobileNav.removeClass('mobile-nav--help-only');
  ...
  pas.closeMobileNav = function() {
    ...
    pas.navCloseTimeout = setTimeout(function() {
  ...
  pas.collapseQuestion = function(e){
